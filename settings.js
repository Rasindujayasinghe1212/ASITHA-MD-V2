...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=GzZDDIxD#LFDPKIHwtNdk2cKWGjOdXOWs5kFfXNTlZK06tGsiuvo' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!!*RASIYA OFFICIAL " : process.env.ALIVE_MSG,
